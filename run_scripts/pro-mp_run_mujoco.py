...
if __name__=="__main__":
    ...
    parser.add_argument('--sampler', type=int, default=0, help='test setting')
    ...
    args.dump_path = meta_policy_search_path + '/data/pro-mp/run_test_%d_seed_%d' % (args.sampler, args.seed)
